<x-filament-panels::page>
    @php
        ...
        $editProfileUrl = \App\Filament\Pages\EditProfile::getUrl();
    @endphp
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <div class="rb-admin-profile__card lg:col-span-2 p-6">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        <div class="rb-admin-profile__chip flex items-center gap-3 px-4 py-3">
                            <div class="rb-admin-profile__chip-icon rb-admin-profile__chip-icon--emerald flex h-9 w-9 items-center justify-center">
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="min-w-0">
                                <div class="rb-admin-profile__chip-label text-[11px] font-semibold">Phone</div>
                                <div class="rb-admin-profile__chip-value truncate text-sm font-semibold">{{ $this->user->phone_number ?? 'Not provided' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="rb-admin-profile__card p-6">
                    ...
                    <div class="rb-admin-profile__rows mt-4 text-sm">
                        <div class="rb-admin-profile__row flex items-center justify-between py-3">
                            <div class="rb-admin-profile__row-label text-xs font-semibold">Age</div>
                            <div class="rb-admin-profile__row-value font-semibold">{{ $this->user->age ?? '—' }}</div>
                        </div>
                        <div class="rb-admin-profile__row flex items-center justify-between py-3">
                            <div class="rb-admin-profile__row-label text-xs font-semibold">Gender</div>
                            <div class="rb-admin-profile__row-value font-semibold capitalize">{{ $this->user->gender ?? '—' }}</div>
                        </div>
                        <div class="rb-admin-profile__row flex items-center justify-between py-3">
