    ...
    <div class="bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/2 bg-gradient-to-br from-purple-600 to-indigo-700 p-8 flex flex-col items-center justify-center text-white relative overflow-hidden">
            ...
            <div class="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
                ...
                <div class="absolute bottom-10 right-10 w-40 h-40 rounded-full bg-pink-400 blur-3xl"></div>
            </div>
            ...
            <div class="z-10 flex flex-col items-center text-center">
                ...
                <h1 class="text-3xl font-bold mb-2 tracking-wide">RelaxBook {{ $this->getPanelName() }}</h1>
                
                <a href="{{ url('/') }}" class="mt-8 px-8 py-2 bg-white text-indigo-700 font-bold rounded-full shadow-lg hover:bg-gray-100 transition transform hover:scale-105">
                    Go to Homepage >
                </a>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/2 bg-white p-8 md:p-12">
            <div class="max-w-md mx-auto">
                ...
                <p class="text-gray-500 mb-8 text-sm">Sign in to manage the system.</p>
                ...
                <form wire:submit="authenticate" class="space-y-6">
                    ...
                    <div class="flex items-center">
                        <input id="remember_me" type="checkbox" wire:model="data.remember" class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                    ...
                    <button type="submit" 
                        ...
                        class="w-full py-3 bg-gradient-to-r from-blue-700 to-purple-600 hover:from-blue-800 hover:to-purple-700 text-white font-bold rounded-lg shadow-md transform transition hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-75 disabled:cursor-wait">
