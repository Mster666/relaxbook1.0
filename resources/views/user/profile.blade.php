...
<head>
    ...
    <title>RelaxBook - My Profile</title>
                ...
                <div class="flex items-center gap-4" x-data="{ 
                    ...
                    <div class="relative">
                        <button @click="open = !open" class="flex items-center gap-2 focus:outline-none group">
                            ...
                            <div class="relative">
                                @if (Auth::user()->profile_picture)
                                    <img class="rounded-full ring-2 ring-gray-100 dark:ring-gray-700 group-hover:ring-indigo-100 dark:group-hover:ring-indigo-900 transition-all" src="{{ Storage::url(Auth::user()->profile_picture) }}" alt="{{ Auth::user()->name }}" width="40" height="40" style="width: 40px; height: 40px; object-fit: cover;">
                                @else
