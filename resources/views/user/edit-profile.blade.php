...
<head>
    ...
    <title>RelaxBook - Edit Profile</title>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-2">
                                        ...
                                        <li>
                                            <div class="ml-5 space-y-1 border-l-2 border-gray-100 dark:border-gray-800 pl-4 my-2">
                                                <a href="{{ route('profile.edit') }}" @click="mobileMenuOpen = false" class="block px-2 py-2 text-sm font-medium rounded-lg text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 transition-colors">
                                                    Edit Profile
                                                </a>
                                                <a href="{{ route('profile.password') }}" @click="mobileMenuOpen = false" class="block px-2 py-2 text-sm font-medium rounded-lg text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors">
                                                    Change Password
                                                </a>
                                            </div>
                                        </li>
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                <div class="mb-6">
                    ...
                    <div class="ml-4 space-y-1 border-l-2 border-gray-100 dark:border-gray-700 pl-3 my-2">
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/50 transition-colors">
                            Edit Profile
                        </a>
                        <a href="{{ route('profile.password') }}" class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                            Change Password
                        </a>
                    </div>
            ...
            <div class="p-4 border-t border-gray-100 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    @if (Auth::user()->profile_picture)
                        <img class="w-8 h-8 rounded-full object-cover" src="{{ Storage::url(Auth::user()->profile_picture) }}" alt="{{ Auth::user()->name }}" loading="lazy">
                    @else
